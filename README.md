...
- **[ElevenLabs](src/elevenlabs)** - Text-to-speech generation using the ElevenLabs API
...
- **[Image Converter](src/image-converter)** - Image manipulation (convert, resize, rotate, crop, filter, etc.) using ImageMagick
